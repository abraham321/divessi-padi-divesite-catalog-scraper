...
1. **Run the Scraper:** 
   Once you have downloaded and installed the necessary libraries, you can run the scraper using your command line. Open your command line tool and navigate to the folder where you saved the scraper.
...
3. **Collect Data:**
   The scraper will run and begin gathering divesite data based on your parameters. Data will be saved to a file in your designated output format (CSV, JSON, etc.).
